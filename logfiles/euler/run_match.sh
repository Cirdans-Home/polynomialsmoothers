...
./anisopsblascuda >> match/log_${smoother}_smatch_l1jac_${idim}_task_1_thr_1_GPU.txt 2>&1 <<EOF
...
./anisopsblas >> match/log_${smoother}_smatch_l1jac_${idim}_task_1_thr_1_CPU.txt 2>&1 <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
