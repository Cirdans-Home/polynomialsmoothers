...
%2d anisotropy 30,001, matching-based aggregation
...
print(figure(1), '-djpeg', '2danimatch-tsolve.jpg');
print(figure(2), '-djpeg', '2danimatch-tit.jpg');
print(figure(3), '-djpeg', '2danimatch-it.jpg');

close all
pause

%2d anisotropy 30,001, VBM aggregation
...
print(figure(1), '-djpeg', '2danisoc1-tsolve.jpg');
print(figure(2), '-djpeg', '2danisoc1-tit.jpg');
print(figure(3), '-djpeg', '2danisoc1-it.jpg');