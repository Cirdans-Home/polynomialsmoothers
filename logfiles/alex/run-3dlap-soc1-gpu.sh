...
mpirun -np ${psize} ./3dlaplacian >> 3dlap/soc1/${degiter}/log_cheby4_soc1_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
...
ML-VSVBM-${degiter}CHEBY4-30L1JAC ! Longer descriptive name for preconditioner (up to 20 chars)
...
DEC                         ! Parallel aggregation: DEC, SYMDEC, DEC    
SOC1                           ! aggregation measure SOC1, SOC1        
8                           ! Requested size of the aggregates for SOC1        
...
mpirun -np ${psize} ./3dlaplacian >> 3dlap/soc1/${degiter}/log_optcheby4_soc1_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                         ! Storage format CSR COO JAD
${idim}                     ! IDIM; domain size. Linear system size is IDIM**3
CONST                       ! PDECOEFF: CONST, EXP, BOX, GAUSS Coefficients of the PDE
...
1.d-7                       ! EPS
%%%%%%%%%%%  Main preconditioner choices %%%%%%%%%%%%%%%%
ML-VSVBM-${degiter}OCHEBY4-30L1JAC ! Longer descriptive name for preconditioner (up to 20 chars)
ML                        ! Preconditioner type: NONE JACOBI GS FBGS BJAC AS ML POLY
%
%%%%%%%%%%%  First smoother (for all levels but coarsest) %%%%%%%%%%%%%%%%
POLY                        ! Smoother type JACOBI FBGS GS BWGS BJAC AS POLY  r 1-level, repeats previous.
...
mpirun -np ${psize} ./3dlaplacian >> 3dlap/soc1/${degiter}/log_optcheby1_soc1_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                         ! Storage format CSR COO JAD
${idim}                     ! IDIM; domain size. Linear system size is IDIM**3
CONST                       ! PDECOEFF: CONST, EXP, BOX, GAUSS Coefficients of the PDE
...
1.d-7                       ! EPS
%%%%%%%%%%%  Main preconditioner choices %%%%%%%%%%%%%%%%
ML-VSVBM-${degiter}OCHEBY1-30L1JAC ! Longer descriptive name for preconditioner (up to 20 chars)
ML                        ! Preconditioner type: NONE JACOBI GS FBGS BJAC AS ML POLY
%
%%%%%%%%%%%  First smoother (for all levels but coarsest) %%%%%%%%%%%%%%%%
POLY                        ! Smoother type JACOBI FBGS GS BWGS BJAC AS POLY  r 1-level, repeats previous.
...
mpirun -np ${psize} ./3dlaplacian >> 3dlap/soc1/${degiter}/log_l1jacobi_soc1_l1jac_${idim}_task_${psize}_thr_1.txt 2>&1  <<EOF
%%%%%%%%%%%  General  arguments % Lines starting with % are ignored.
HLG                         ! Storage format CSR COO JAD
${idim}                     ! IDIM; domain size. Linear system size is IDIM**3
CONST                       ! PDECOEFF: CONST, EXP, BOX, GAUSS Coefficients of the PDE
...
1.d-7                       ! EPS
%%%%%%%%%%%  Main preconditioner choices %%%%%%%%%%%%%%%%
ML-VSVBM-${degiter}L1JAC-30L1JAC ! Longer descriptive name for preconditioner (up to 20 chars)
ML                        ! Preconditioner type: NONE JACOBI GS FBGS BJAC AS ML POLY
%%%%%%%%%%%  First smoother (for all levels but coarsest) %%%%%%%%%%%%%%%%
