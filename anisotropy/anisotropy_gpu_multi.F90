program anisopsblas
  ...
  ! other variables
  integer(psb_ipk_)  :: info, i, k, nth, idxgpu, tngpus, xgpu, ngpus
  ...
  if (.false.) then 
    ...
    call get_gen_data(ctxt,inp_unit,afmt,ne,theta,eps,s_choice)
  end if
...
contains
  ...
  !
  subroutine get_gen_data(ctxt,inp_unit,afmt,idim,theta,eps,solve)
  ...
  subroutine get_smoother_data(ctxt,inp_unit,prec)
    ...
    if (iam == psb_root_) then
      ...
      call read_data(prec%krmeth,inp_unit)      ! krylov method  
